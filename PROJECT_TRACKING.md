...
| **Checkpoint 9** | `perf(web): split center admin routes and optimize bundle` | Phần 2 (I) | **DEFERRED (PHẦN 2)** | Chuyển sang thực hiện tại Phần 2 (I) theo kế hoạch authoritative. |
