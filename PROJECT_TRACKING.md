...
| R08 — Dashboard và end-to-end UX | TECHNICALLY VERIFIED / UX ACCEPTANCE PENDING | MASTER_PLAN R08/P15–P17; UI_UX_SPEC mục 14–18 | `1749e78`, `13bf809`, `ccd017f`, `0f78937`, `c3827f5`, `8d9eb5b`; follow-up polling/accessibility remediation đang ở working tree | Release build sạch; 3.054 non-MySQL + 25/25 live-MySQL tests pass; web 17/17 pass, lint sạch, production build pass; EF no model drift; Docker ba persona được báo cáo và artifact cục bộ tồn tại | Chưa đủ UX Done: toàn bộ Figma URL/reviewer/date/status còn TBD/PENDING; chưa có stakeholder feedback/approval bền vững trong repo; Codex chưa replay được browser artifact do Windows automation helper crash |
