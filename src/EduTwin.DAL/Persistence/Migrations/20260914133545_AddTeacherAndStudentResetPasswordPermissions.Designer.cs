...
namespace EduTwin.DAL.Persistence.Migrations
{
    ...
    [Migration("20260914133545_AddTeacherAndStudentResetPasswordPermissions")]
    partial class AddTeacherAndStudentResetPasswordPermissions
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EduTwin.DAL.AssessmentAndReasoning.Attempt", b =>
                {
                    ...
                    b.Property<string>("AnswerDisplayLatex")
                        .HasColumnType("varchar(2048)")
                        .HasColumnName("answer_display_latex");
            ...
            modelBuilder.Entity("EduTwin.DAL.AssessmentAndReasoning.AttemptAttachment", b =>
                {
                    ...
                    b.Property<string>("UploadNonce")
                        .IsRequired()
                        .HasColumnType("varchar(64)")
                        .HasColumnName("upload_nonce");

                    b.HasKey("AttachmentId")
                        .HasName("pk_attempt_attachments");

                    b.HasIndex("CenterId", "AttemptId")
                        .IsUnique()
                        .HasDatabaseName("ux_attempt_attachments_center_id_attempt_id");

                    b.HasIndex("CenterId", "StorageKey")
                        .IsUnique()
                        .HasDatabaseName("ux_attempt_attachments_center_id_storage_key");

                    b.HasIndex("CenterId", "UploadNonce")
                        .IsUnique()
                        .HasDatabaseName("ux_attempt_attachments_center_id_upload_nonce");

                    b.ToTable("attempt_attachments", null, t =>
                        {
                            t.HasCheckConstraint("ck_attempt_attachments_content_type", "`content_type` = 'image/png'");

                            t.HasCheckConstraint("ck_attempt_attachments_file_size_bytes", "`file_size_bytes` >= 1 AND `file_size_bytes` <= 5242880");
                        });
                });
            ...
            modelBuilder.Entity("EduTwin.DAL.CurriculumAndQuestions.Question", b =>
                {
                    ...
                    b.Property<string>("AnswerEvaluationMode")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("varchar(32)")
                        .HasDefaultValue("TextExact")
            ...
            modelBuilder.Entity("EduTwin.DAL.IdentityAndTenancy.AuthorizationAuditLog", b =>
                {
                    ...
                    b.Property<string>("TargetCenterId")
                        .HasColumnType("varchar(36)")
                        .HasColumnName("target_center_id");
                    ...
                    b.HasIndex("CenterId", "TargetCenterId", "CreatedAt")
            ...
            modelBuilder.Entity("EduTwin.DAL.IdentityAndTenancy.AuthorizationRole", b =>
                {
                    ...
                    b.ToTable("roles", null, t =>
                        {
                            t.HasCheckConstraint("ck_roles_account_type", "`account_type` IN ('Student', 'Teacher', 'CenterManager', 'PlatformAdmin')");
            ...
            modelBuilder.Entity("EduTwin.DAL.IdentityAndTenancy.Permission", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            PermissionId = "5dc8cce2-04b2-5d8b-b632-7b1fe56c2c4b",
                            ActionName = "reset_password",
                            CreatedAt = new DateTime(2026, 9, 9, 0, 0, 0, 0, DateTimeKind.Utc),
                            Description = "Cho phép reset_password students trong phạm vi được cấp.",
                            IsDelegable = true,
                            IsSensitive = true,
                            ModuleName = "Organization",
                            PermissionCode = "organization.students.reset_password",
                            ResourceName = "Students",
                            Status = "Active",
                            UpdatedAt = new DateTime(2026, 9, 9, 0, 0, 0, 0, DateTimeKind.Utc)
                        },
                        ...
                        new
                        {
                            PermissionId = "38aa5060-4615-5d50-8c81-cdf7a1fd6b39",
                            ActionName = "reset_password",
                            CreatedAt = new DateTime(2026, 9, 9, 0, 0, 0, 0, DateTimeKind.Utc),
                            Description = "Cho phép reset_password teachers trong phạm vi được cấp.",
                            IsDelegable = true,
                            IsSensitive = true,
                            ModuleName = "Organization",
                            PermissionCode = "organization.teachers.reset_password",
                            ResourceName = "Teachers",
                            Status = "Active",
                            UpdatedAt = new DateTime(2026, 9, 9, 0, 0, 0, 0, DateTimeKind.Utc)
                        },
                        ...
                        new
                        {
                            PermissionId = "6fe640d3-a019-5670-875f-ef0470c8eba8",
                            ActionName = "manage_own",
                            CreatedAt = new DateTime(2026, 9, 9, 0, 0, 0, 0, DateTimeKind.Utc),
                            Description = "Cho phép manage_own account trong phạm vi được cấp.",
                            IsDelegable = false,
                            IsSensitive = false,
                            ModuleName = "Platform",
                            PermissionCode = "platform.account.manage_own",
                        ...
                        new
                        {
                            PermissionId = "4e09f21c-6af9-5e3c-96d6-61f99343de4a",
                            ActionName = "read",
                            CreatedAt = new DateTime(2026, 9, 9, 0, 0, 0, 0, DateTimeKind.Utc),
                            Description = "Cho phép read audit trong phạm vi được cấp.",
                            IsDelegable = false,
                            IsSensitive = true,
                            ModuleName = "Platform",
                            PermissionCode = "platform.audit.read",
                            ResourceName = "Audit",
                            Status = "Active",
                            UpdatedAt = new DateTime(2026, 9, 9, 0, 0, 0, 0, DateTimeKind.Utc)
                        },
                        new
                        {
                            PermissionId = "a39a542b-7b4f-55f6-aa8d-4f6f2073f852",
                            ActionName = "manage",
                            CreatedAt = new DateTime(2026, 9, 9, 0, 0, 0, 0, DateTimeKind.Utc),
                            Description = "Cho phép manage centers trong phạm vi được cấp.",
                            IsDelegable = false,
                            IsSensitive = true,
                            ModuleName = "Platform",
                        ...
                        new
                        {
                            PermissionId = "d49095fa-30ce-5167-885e-489b19188769",
                            ActionName = "read",
                            CreatedAt = new DateTime(2026, 9, 9, 0, 0, 0, 0, DateTimeKind.Utc),
                            Description = "Cho phép read centers trong phạm vi được cấp.",
                            IsDelegable = false,
                            IsSensitive = true,
                            ModuleName = "Platform",
                            PermissionCode = "platform.centers.read",
                            ResourceName = "Centers",
                            Status = "Active",
                            UpdatedAt = new DateTime(2026, 9, 9, 0, 0, 0, 0, DateTimeKind.Utc)
                        },
                        new
                        {
                            PermissionId = "faa3342c-5473-521b-a321-eb3844f638fb",
                            ActionName = "manage",
                            CreatedAt = new DateTime(2026, 9, 9, 0, 0, 0, 0, DateTimeKind.Utc),
                            Description = "Cho phép manage managers trong phạm vi được cấp.",
                            IsDelegable = false,
                            IsSensitive = true,
                            ModuleName = "Platform",
                            PermissionCode = "platform.managers.manage",
            ...
            modelBuilder.Entity("EduTwin.DAL.IdentityAndTenancy.PermissionAccountType", b =>
                {
                    ...
                    b.ToTable("permission_account_types", null, t =>
                        {
                            t.HasCheckConstraint("ck_permission_account_types_account_type", "`account_type` IN ('Student', 'Teacher', 'CenterManager', 'PlatformAdmin')");
                        });
            ...
            modelBuilder.Entity("EduTwin.DAL.IdentityAndTenancy.RolePermission", b =>
                {
                    ...
                    b.ToTable("role_permissions", null, t =>
                        {
                            t.HasCheckConstraint("ck_role_permissions_account_type", "`account_type` IN ('Student', 'Teacher', 'CenterManager', 'PlatformAdmin')");
                        });
                });
            ...
            modelBuilder.Entity("EduTwin.DAL.IdentityAndTenancy.User", b =>
                {
                    ...
                    b.ToTable("users", null, t =>
                        {
                            t.HasCheckConstraint("ck_users_role_name", "role_name IN ('Student', 'Teacher', 'CenterManager', 'PlatformAdmin')");
            ...
            modelBuilder.Entity("EduTwin.DAL.IdentityAndTenancy.UserRoleAssignment", b =>
                {
                    ...
                    b.ToTable("user_roles", null, t =>
                        {
                            t.HasCheckConstraint("ck_user_roles_account_type", "`account_type` IN ('Student', 'Teacher', 'CenterManager', 'PlatformAdmin')");
            ...
            modelBuilder.Entity("EduTwin.DAL.Organization.Center", b =>
                {
                    ...
                    b.Property<string>("PrimaryManagerUserId")
                        .HasColumnType("VARCHAR(36)")
                    ...
                    b.HasIndex("PrimaryManagerUserId")
                        .IsUnique()
                        .HasDatabaseName("ix_centers_primary_manager_user_id");

                    b.HasIndex("CenterId", "PrimaryManagerUserId");
            ...
            modelBuilder.Entity("EduTwin.DAL.Recommendations.RecommendationGenerationState", b =>
                {
                    b.Property<string>("CenterId")
                        .HasColumnType("varchar(36)")
                        .HasColumnName("center_id");
                    ...
                    b.Property<ulong?>("LastSourceAttemptId")
                        .HasColumnType("bigint unsigned")
                    ...
                    b.HasKey("CenterId", "StudentId", "SubjectId")
                        .HasName("pk_recommendation_generation_states");

                    b.HasIndex("CenterId", "SubjectId")
                        .HasDatabaseName("ix_recommendation_generation_states_center_id_subject_id");

                    b.ToTable("recommendation_generation_states", null, t =>
                        {
                            t.HasCheckConstraint("ck_recommendation_generation_states_outcome", "`last_outcome` IN ('Generated', 'NoCandidate', 'Blocked')");
                        });
                });
            ...
            modelBuilder.Entity("EduTwin.DAL.AssessmentAndReasoning.AttemptAttachment", b =>
                {
                    b.HasOne("EduTwin.DAL.AssessmentAndReasoning.Attempt", "Attempt")
                        .WithOne("Attachment")
                        .HasForeignKey("EduTwin.DAL.AssessmentAndReasoning.AttemptAttachment", "CenterId", "AttemptId")
                        .HasPrincipalKey("EduTwin.DAL.AssessmentAndReasoning.Attempt", "CenterId", "AttemptId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
            ...
            modelBuilder.Entity("EduTwin.DAL.IdentityAndTenancy.AuthorizationAuditLog", b =>
                {
                    b.HasOne("EduTwin.DAL.Organization.Center", "TargetCenter")
                        .WithMany()
                        .HasForeignKey("TargetCenterId")
                        .OnDelete(DeleteBehavior.Restrict)
            ...
            modelBuilder.Entity("EduTwin.DAL.Organization.Center", b =>
                {
                    b.HasOne("EduTwin.DAL.IdentityAndTenancy.User", "PrimaryManagerUser")
                        .WithMany()
                        .HasForeignKey("CenterId", "PrimaryManagerUserId")
                        .HasPrincipalKey("CenterId", "UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_centers_primary_manager_user");

                    b.Navigation("PrimaryManagerUser");
                });
