...
// ============================================================================
const CenterManagerStudentTwinView: React.FC = () => {
  ...
  const {
    ...
    queryKey: ["centerManagerStudentTwin", studentId, subjectId],
          ...
          <div className="mx-auto max-w-2xl rounded-xl bg-white p-8 text-center shadow-sm ring-1 ring-slate-200">
            ...
            <p className="mt-2 text-slate-600">
              {(error as Error)?.message ||
                "Không thể truy cập dữ liệu Digital Twin của học sinh hoặc học sinh không thuộc trung tâm."}
            </p>
    ...
    <CenterManagerThemeScope data-actor="center-manager">
      <div className="min-h-screen bg-slate-50 p-6">
        <div className="mx-auto max-w-6xl space-y-6">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-200 pb-4">
            <div>
              <div className="flex items-center gap-2 text-xs font-semibold text-slate-500 mb-1">
                ...
                <span>/</span>
                <Link to="/quan-ly/hoc-sinh" className="hover:text-indigo-600">Học sinh</Link>
                <span>/</span>
                <span className="text-slate-900">Hồ sơ năng lực</span>
              </div>
              <h1 className="text-2xl font-bold text-slate-900">
                Hồ Sơ Năng Lực Học Sinh (Digital Twin)
              </h1>
          ...
          {/* Cognitive Growth Highlights (Single-subject bounded) */}
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="rounded-xl bg-white p-5 shadow-sm ring-1 ring-slate-200">
              ...
              <p className="mt-1 text-xs text-slate-500">Chỉ số trung bình các chuyên đề trong môn đang chọn</p>
            </div>
            ...
            <div className="rounded-xl bg-white p-5 shadow-sm ring-1 ring-slate-200">
              ...
              <p className="mt-1 text-xs text-slate-500">Lượt làm bài được ghi nhận trong môn</p>
            </div>
          </div>
...
// ============================================================================
const TeacherStudentTwinLegacyView: React.FC = () => {
  const { studentId } = useParams<{ studentId: string }>();
  const [searchParams, setSearchParams] = useSearchParams();
  const subjectId = searchParams.get("subjectId") || undefined;
